	...
	const alternativePath =
		alternativePaths.find((altPath) => {
			return fs.existsSync(
				path.join(import.meta.cwd(), altPath, 'schema.prisma')
			);
		}) ?? alternativePaths[0];

	config.dirname = path.join(import.meta.cwd(), alternativePath);
...
path.join(import.meta.cwd(), 'prisma/generated/client/schema.prisma');
