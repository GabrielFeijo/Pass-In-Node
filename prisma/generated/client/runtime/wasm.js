...
function Ye(e, t) {
	...
	for (
		a = s = R = he(R.minus(te), R.plus(te), v), C = _(R.times(R), v), i = 3;
		;
					...
					: a > 5 ||
					  (a == 5 &&
							(r == 4 ||
								f ||
								(r == 6 &&
									(n > 0 ? (i > 0 ? v / Se(10, s - i) : 0) : T[C - 1]) % 10 &
										1) ||
								r == (e.s < 0 ? 8 : 7))))),
		t < 1 || !T[0])
	)
...
var Fe,
	...
	on = se(() => {
		...
		A.logarithm = A.log = function (e) {
			...
			return r.eq(te)
				? new n(0)
				: ((B = !1), (t = he(Ye(r, o), Ye(e, o), o)), (B = !0), _(t, i));
		};
		...
		A.precision = A.sd = function (e) {
			...
			if (
				((t = q(i) + 1), (n = i.d.length - 1), (r = n * D + 1), (n = i.d[n]), n)
			) {
				for (; n % 10 == 0; n /= 10) r--;
...
var ai = (e) => (Array.isArray(e) ? e : e.split('.')),
	...
	li = (e, t, r) =>
		ai(t).reduceRight(
			(n, i, o, s) => Object.assign({}, Or(e, s.slice(0, o)), { [i]: n }),
			r
		);
function As(e, t) {
			...
			if (e) {
				...
				for (let [r, n] of Object.entries(e)) {
					...
					if (typeof n != 'object' || Array.isArray(n))
						throw new F(`Invalid value ${JSON.stringify(
							e
